...
namespace MarioBros.Elements.Objects
{
    public class Koopa : Monster, IGravity
    {
        public Koopa(Elements.Resources resources, Data.Object obj) : base(resources, obj)
        {
            ...
            base.AnimationRec_Normal = base.Create_Animation(_unitSize,
                new Point(224, 384),
                new Point(256, 384)
            );
            base.AnimationRec_Dying = base.Create_Animation(new Size(resources.MapData.tilewidth, resources.MapData.tileheight), new Point(192, 384));
